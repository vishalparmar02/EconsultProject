...
#define PAY_URL                     TEST_VERSION ? @"https://econsult.jshealthtech.com/pay-for-mobile-appointments/%@" : @"https://https://consult.drateetsharma.com/pay-for-mobile-appointments/%@"
