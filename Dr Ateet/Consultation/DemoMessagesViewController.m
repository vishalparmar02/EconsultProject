...
- (void)viewDidLoad
{
    ...
    UIButton *videoButton = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, 25, 25)];
    [videoButton setImage:[UIImage imageNamed:@"video_call"] forState:UIControlStateNormal];
    [videoButton addTarget:self
                    action:@selector(videoTapped)
          forControlEvents:UIControlEventTouchUpInside];
    
    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithCustomView:videoButton];
...
- (void)videoTapped{
    ARTCVideoChatViewController *vc = [[ARTCVideoChatViewController alloc] init];
