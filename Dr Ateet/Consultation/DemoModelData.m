...
- (instancetype)init
{
    ...
    if (self) {
        ...
        jsqImage = [JSQMessagesAvatarImageFactory avatarImageWithImage:[UIImage imageNamed:@"doctor_photo"]
                                                                                       diameter:kJSQMessagesCollectionViewAvatarSizeDefault];
        ...
        self.users = @{ kJSQDemoAvatarIdCook : kJSQDemoAvatarDisplayNameCook,
